...
class Database:
    ...
    def init_db(self):
        ...
        # Таблица заказов (с адресом и ПВЗ!)
        cur.execute('''
            CREATE TABLE orders (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        # Товары
        items = [
            ('🍯 Мёд липовый', 'Натуральный липовый мёд', 'мёд', 10, 100, ''),
            ('🍯 Мёд гречишный', 'Тёмный гречишный мёд', 'мёд', 12, 80, ''),
            ('🍯 Мёд горный', 'Собран в горах', 'мёд', 15, 50, ''),
            ('🍯 Мёд с прополисом', 'Укрепляет иммунитет', 'мёд', 18, 40, ''),
            ('👑 Мёд с маточным молочком', 'Элитный сорт', 'мёд', 25, 20, ''),
            ('🌸 Пыльца цветочная', '100% натуральная', 'прополис', 8, 60, ''),
            ('🐝 Прополис', 'Натуральный прополис', 'прополис', 30, 50, ''),
            ('🕯️ Воск пчелиный', 'Натуральный воск', 'воск', 20, 200, ''),
        ]
